...
#+BEGIN_QUOTE
"All mail clients suck. This one just sucks less." -Michael R. Elkins, circa 1995
#+END_QUOTE
...
*How am I?* Set my personal and account information. *Note*: This
...
list to cleanup default keybindings. Spotted [[https://github.com/iagox86/mutt][here]]
...
#+BEGIN_SRC bash
set editor="emacs -Q" # TODO: Add a minimal version of my Emacs configuration.
